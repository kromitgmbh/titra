  ...
  manifest = (
    ...
    metadata = (
      ...
      icons = (
        ...
        appGrid = (png = embed "public/img/appgrid-128x128.png"),
        grain = (png = embed "public/img/grain-24x24.png"),
        market = (png = embed "public/img/market-150x150.png"),
        marketBig = (png = embed "public/img/market-big-300x300.png"),
      ),
